...
export default function AuthSignIn() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-elma-purple via-elma-pink to-elma-sky flex items-center justify-center p-4">
      <div className="bg-elma-white rounded-xl2 shadow-soft p-8 w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-elma-ink mb-2">ELMA Admin</h1>
          <p className="text-elma-ink/60">Sign in to access the admin portal</p>
        </div>
