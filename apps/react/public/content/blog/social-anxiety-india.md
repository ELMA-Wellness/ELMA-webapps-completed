...
[ELMA](https://elma.ltd/) is built specifically to help with this — daily voice-based emotional check-ins that build pattern recognition over time, so you start to understand your anxiety rather than just being ruled by it.
...
**[ELMA](https://elma.ltd/)** supports your emotional work between therapy sessions — or as a first step when therapy isn't yet accessible. Daily emotional check-ins, CBT-based tools, pattern tracking. Free on Android and iOS.
