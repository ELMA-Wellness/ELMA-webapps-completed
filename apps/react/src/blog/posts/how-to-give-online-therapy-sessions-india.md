...
**Disclosure of trauma or distress:**
When a client becomes visibly distressed on camera:
...
**Dissociation:**
If a client appears to dissociate during an online session:
...
If a client expresses suicidal intent during a session:
